...
**-- -- -- -- -- -- -- -- --
 ...
 -- -- -- -- - 
 رباعي
 ss_xs - { عشوائي - كود جديد }
 
 رباعي1
 s_xxx - { شخطه بدايه - كود الجديد }
 
 رباعي2 
 ss_sx - { شخطه وسط - كود الجديد }
 
 رباعي3
 sss_x - { شخطه بلخير - كود الجديد }
 
 رباعي4
 sss_x - { عشوائي - كود جديد }
 
 رباعي5
 s_xxx - { شخطه بدايه - كود قديم }
 
 رباعي6
 ss_sx - { شخطه وسط - كود قديم }
 
 رباعي7
 sss_x - { شخطه وسط - كود قديم }
 
 رباعي8
 ss_sx - { عشوائي حروف فقط }
   -- -- -- -- -- 
